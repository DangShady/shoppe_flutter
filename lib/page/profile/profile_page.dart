      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Complete your profile 📋', style: Style().h3Bold,),
            SizedBox(height: 16.h,),
            Text('Please enter your profile. Don’t worry, only you can see your personal data. No one else will be able to see it. Or you can skip it for now.',style: Style().bodyXLargeRegular,),
    ...
    children: [
      ...
      selectedImage != null
          ...
          : CircleAvatar(
              ...
              backgroundImage: AssetImage(ImageConstant.icProfile),
...
SizedBox(height: 24.h,),
            ...
            SizedBox(height: 24.h,),
            Text('Phone Number', style: Style().bodyLargeBold,),
            SizedBox(height: 16.h,),
InternationalPhoneNumberInput(
                onInputChanged: _onPhoneNumberChanged, // Gọi hàm xử lý khi số điện thoại thay đổi
                initialValue: PhoneNumber(isoCode: 'VN'), // Quốc gia mặc định (ví dụ: Việt Nam)
                ...
                keyboardType: TextInputType.phone,                // Các thuộc tính và cấu hình khác
              ),
      SizedBox(height: 24.h,),
       Text('Gender', style: Style().bodyLargeBold,),
  ...
  decoration: InputDecoration(
    ...
    hintStyle: Style().h5Bold.copyWith(color: Color(0xff9E9E9E)),
      ...
      SizedBox(height: 24.h),
       Text('Date of Birth',style: Style().bodyLargeBold,),
       Divider(),
       SizedBox(height: 24.h,),
      Row(
