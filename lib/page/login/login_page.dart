    ...
    return Obx(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Welcome back 👋', style: Style().h3Bold,),
      ...
      Row(
        children: [
          ...
          SizedBox(width: 16.h,),
          Text('Remember me',style: Style().bodyLargeSemiBold,),
        ],
      ),
      SizedBox(height: 64.h),
      Center(child: Text('Forgot password?', style: Style().h6Bold.copyWith(color: Style.primaryColor,))),
      SizedBox(height: 32.h,),
      Padding(
        ...
        child: Row(
          children: [
            ...
            Text('  Sign up',style: Style().bodyLargeBold.copyWith(color: Style.primaryColor))
          ],
        ),
      ),
      SizedBox(height: 32,),
